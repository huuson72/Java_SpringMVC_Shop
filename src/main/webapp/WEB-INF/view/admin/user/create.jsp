                                        ...
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <form:form method="post" action="/admin/user/create"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <label class="form-label"><span style="color: red;">*</span> Mật
                                                        khẩu:</label>
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    <label class="form-label"><span style="color: red;">*</span> Số điện
                                                        thoại:</label>
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <label class="form-label"><span style="color: red;">*</span> Họ
                                                        tên:</label>
