...
COPY src /son/spring-mvc/src
COPY pom.xml /son/spring-mvc

# Set the working directory
WORKDIR /son/spring-mvc
...
COPY --from=build /son/spring-mvc/target/*.war /son/spring-mvc/app.war

EXPOSE 8080

ENTRYPOINT ["java", "-jar", "/son/spring-mvc/app.war"]
